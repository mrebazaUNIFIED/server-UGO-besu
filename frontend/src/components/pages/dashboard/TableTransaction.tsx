...
export const TableTransaction = () => {
  ...
  return (
    <div className="w-full mt-10">
      <div className="w-full py-8 px-4 mx-auto rounded-4xl bg-white ">
        {/* Header */}
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="overflow-auto max-h-96">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr className="">
                  <th className="px-6 py-5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">N°</th>
                  <th className="px-6 py-5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sender / Recipient</th>
                  <th className="px-6 py-5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Amount (USFCI)</th>
                  <th className="px-6 py-5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date and time</th>
                  <th className="px-6 py-5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  return (
                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <span className="font-mono max-w-xs truncate block flex items-center" title={item.senderAddress}>
                          {truncateAddress(item.senderAddress)} <FaArrowRight className="mx-1" /> {truncateAddress(item.recipientAddress)}
                        </span>
                      </td>
